...
bool ScreenRecorder::setupVideoStream()
{
    ...
    m_videoCodecContext->time_base = {1, FRAME_RATE};
    m_videoCodecContext->framerate = {FRAME_RATE, 1};
    m_videoCodecContext->pix_fmt = AV_PIX_FMT_YUV420P;
    m_videoCodecContext->bit_rate = VIDEO_BITRATE;
    m_videoCodecContext->gop_size = 10;
    m_videoCodecContext->max_b_frames = 1;
...
bool ScreenRecorder::setupAudioStream()
{
    ...
    m_audioCodecContext->channels = AUDIO_CHANNELS;
    ...
    if (m_audioCodecContext) {
        ...
        while (m_audioFifo && av_audio_fifo_size(m_audioFifo) > 0) {
            ...
            if (av_audio_fifo_read(m_audioFifo, (void**)m_audioFrame->data, samplesToRead) > 0) {
                ...
                m_audioFrame->pts = m_audioFrameCount * samplesToRead;
                m_audioFrameCount++;
